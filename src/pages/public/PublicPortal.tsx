...
import { TrendingUp, CloudSun, Droplets, Volume2, Wind, MapPin, Radio } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {pollutionType === 'air' && hasLiveData() && (
        <div className="flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-200 rounded-lg text-sm text-green-800">
          ...
          <span className="font-semibold">Live CPCB Data</span>
          <span className="text-green-600">— Real-time AQI readings from data.gov.in (Chhattisgarh monitoring stations)</span>
        </div>
      )}
