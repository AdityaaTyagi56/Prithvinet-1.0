    ...
    >
      ...
      <div className="relative z-20 flex min-h-screen items-center justify-center px-4 py-10">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className={`w-[520px] max-w-full transform transition-all duration-[800ms] ease-out ${cardVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            <div className="rounded-2xl border border-white/30 bg-white/95 backdrop-blur-md p-8 shadow-xl">
            ...
            <div className="mt-10">
              ...
              <div className="mt-5 bg-gradient-to-br from-green-50/60 to-emerald-50/60 border border-green-100 rounded-xl p-4 shadow-sm">
                <div className="space-y-2">
                  <div
                    className="flex items-start gap-3 cursor-pointer hover:bg-white p-3 rounded-lg transition-all group border border-transparent hover:border-green-200"
                    onClick={() => setEmail("admin@cecb.gov.in")}
                  >
                    <span className="mt-0.5 shrink-0 px-2 py-0.5 rounded text-[10px] font-bold bg-red-100 text-red-700 uppercase tracking-wide">Admin</span>
                    <div className="min-w-0">
                      <p className="text-sm font-bold text-gray-900 group-hover:text-green-800">System Administrator</p>
                      <p className="text-xs text-gray-500 mt-0.5">Full platform access — user management, system config, all dashboards & data</p>
                    </div>
                  </div>
                  <div
                    className="flex items-start gap-3 cursor-pointer hover:bg-white p-3 rounded-lg transition-all group border border-transparent hover:border-green-200"
                  ...
                  >
                    <span className="mt-0.5 shrink-0 px-2 py-0.5 rounded text-[10px] font-bold bg-purple-100 text-purple-700 uppercase tracking-wide">Secretary</span>
                    <div className="min-w-0">
                      <p className="text-sm font-bold text-gray-900 group-hover:text-green-800">Member Secretary, CECB</p>
                      <p className="text-xs text-gray-500 mt-0.5">State-wide oversight — compliance approvals, policy reports, all regional data</p>
                    </div>
                  </div>
                  <div
                    className="flex items-start gap-3 cursor-pointer hover:bg-white p-3 rounded-lg transition-all group border border-transparent hover:border-green-200"
                  ...
                  >
                    <span className="mt-0.5 shrink-0 px-2 py-0.5 rounded text-[10px] font-bold bg-blue-100 text-blue-700 uppercase tracking-wide">Regional</span>
                    <div className="min-w-0">
                      <p className="text-sm font-bold text-gray-900 group-hover:text-green-800">Regional Officer — Raipur</p>
                      <p className="text-xs text-gray-500 mt-0.5">District-level monitoring — inspections, industry compliance & local alerts</p>
                    </div>
                  </div>
                  <div
                    className="flex items-start gap-3 cursor-pointer hover:bg-white p-3 rounded-lg transition-all group border border-transparent hover:border-green-200"
                  ...
                  >
                    <span className="mt-0.5 shrink-0 px-2 py-0.5 rounded text-[10px] font-bold bg-blue-100 text-blue-700 uppercase tracking-wide">Regional</span>
                    <div className="min-w-0">
                      <p className="text-sm font-bold text-gray-900 group-hover:text-green-800">Regional Officer — Bhilai</p>
                      <p className="text-xs text-gray-500 mt-0.5">District-level monitoring — inspections, industry compliance & local alerts</p>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <span className="mt-0.5 shrink-0 px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-100 text-emerald-700 uppercase tracking-wide">Citizen</span>
                    <div className="min-w-0">
                      <p className="text-sm font-bold text-gray-900 group-hover:text-green-800">Public Citizen</p>
                      <p className="text-xs text-gray-500 mt-0.5">Public portal only — view AQI, forecasts & file grievances</p>
                    </div>
                  </div>
                </div>
              </div>
