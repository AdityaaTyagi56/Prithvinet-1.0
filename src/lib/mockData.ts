...
export interface IndustryData {
  ...
  live_emissions?: { [key: string]: number | string };
}

export function getIndustryTracker(): IndustryData[] {
  return [
    { id: 'ind-1', name: 'Bharat Steel Works', type: 'Iron & Steel', region: 'Durg', consent_valid_until: '2026-12-31', air_status: 'non-compliant', water_status: 'warning', noise_status: 'non-compliant', last_inspection: '2026-02-15', total_violations_ytd: 8, risk_score: 89, live_emissions: { 'PM2.5': 142.5, 'PM10': 185, 'SO2': 94.2 } },
    { id: 'ind-2', name: 'Chhattisgarh Power Ltd', type: 'Thermal Power', region: 'Korba', consent_valid_until: '2027-03-31', air_status: 'non-compliant', water_status: 'compliant', noise_status: 'compliant', last_inspection: '2026-01-20', total_violations_ytd: 5, risk_score: 72, live_emissions: { 'PM2.5': 120.4, 'PM10': 155.0, 'SO2': 65.0, 'NO2': 42.1 } },
    { id: 'ind-3', name: 'Raipur Chemicals', type: 'Chemical Mfg', region: 'Raipur', consent_valid_until: '2026-09-30', air_status: 'warning', water_status: 'non-compliant', noise_status: 'compliant', last_inspection: '2026-02-28', total_violations_ytd: 4, risk_score: 65, live_emissions: { 'PM2.5': 88.0, 'PM10': 110.2, 'SO2': 45.1, 'CO': 1.2 } },
    { id: 'ind-4', name: 'Korba Cement Corp', type: 'Cement', region: 'Korba', consent_valid_until: '2026-06-30', air_status: 'non-compliant', water_status: 'n/a', noise_status: 'warning', last_inspection: '2026-03-01', total_violations_ytd: 6, risk_score: 78, live_emissions: { 'PM2.5': 165.2, 'PM10': 210.0, 'SO2': 38.4, 'NO2': 55.0 } },
    { id: 'ind-5', name: 'Durg Alloys Pvt Ltd', type: 'Metallurgy', region: 'Durg', consent_valid_until: '2027-01-15', air_status: 'warning', water_status: 'compliant', noise_status: 'compliant', last_inspection: '2026-02-10', total_violations_ytd: 2, risk_score: 38, live_emissions: { 'PM2.5': 65.5, 'PM10': 95.0, 'SO2': 22.1, 'CO': 2.5 } },
    { id: 'ind-6', name: 'CG Paper Mills', type: 'Pulp & Paper', region: 'Raipur', consent_valid_until: '2026-08-31', air_status: 'compliant', water_status: 'non-compliant', noise_status: 'n/a', last_inspection: '2026-01-05', total_violations_ytd: 5, risk_score: 71, live_emissions: { 'PM2.5': 45.0, 'PM10': 60.5, 'SO2': 18.0 } },
    { id: 'ind-7', name: 'Raipur Dyeing Cluster', type: 'Textile/Dyeing', region: 'Raipur', consent_valid_until: '2026-07-31', air_status: 'n/a', water_status: 'non-compliant', noise_status: 'n/a', last_inspection: '2026-02-22', total_violations_ytd: 7, risk_score: 82, live_emissions: { 'PM2.5': 78.4, 'PM10': 105.0, 'NO2': 48.2 } },
    { id: 'ind-8', name: 'Korba Sugar Factory', type: 'Sugar/Distillery', region: 'Korba', consent_valid_until: '2027-02-28', air_status: 'compliant', water_status: 'warning', noise_status: 'compliant', last_inspection: '2026-03-05', total_violations_ytd: 3, risk_score: 45, live_emissions: { 'PM2.5': 38.5, 'PM10': 55.0, 'SO2': 12.4 } },
    { id: 'ind-9', name: 'Durg Distillery', type: 'Distillery', region: 'Durg', consent_valid_until: '2026-11-30', air_status: 'n/a', water_status: 'non-compliant', noise_status: 'compliant', last_inspection: '2026-02-18', total_violations_ytd: 4, risk_score: 68, live_emissions: { 'PM2.5': 55.2, 'PM10': 82.0, 'NO2': 28.5 } },
    { id: 'ind-10', name: 'Bilaspur Stone Crusher', type: 'Mining/Crushing', region: 'Bilaspur', consent_valid_until: '2026-05-15', air_status: 'warning', water_status: 'n/a', noise_status: 'non-compliant', last_inspection: '2026-01-25', total_violations_ytd: 3, risk_score: 58, live_emissions: { 'PM2.5': 92.4, 'PM10': 150.0, 'SO2': 15.0 } },
    { id: 'ind-11', name: 'Raipur Cement Crusher', type: 'Cement', region: 'Raipur', consent_valid_until: '2026-10-31', air_status: 'compliant', water_status: 'n/a', noise_status: 'non-compliant', last_inspection: '2026-03-08', total_violations_ytd: 2, risk_score: 52, live_emissions: { 'PM2.5': 42.1, 'PM10': 78.5, 'NO2': 22.0 } },
    { id: 'ind-12', name: 'Bhilai Chemicals', type: 'Chemical Mfg', region: 'Durg', consent_valid_until: '2026-04-30', air_status: 'compliant', water_status: 'non-compliant', noise_status: 'warning', last_inspection: '2026-02-05', total_violations_ytd: 6, risk_score: 76, live_emissions: { 'PM2.5': 35.8, 'PM10': 52.0, 'SO2': 55.4, 'CO': 1.8 } },
  ];
}
